...
#SBATCH -t 08:00:00  # Zero day, four hour
...
# python asvd.py --model_id="facebook/opt-125m" --act_aware --alpha 0.5 --n_calib_samples 16 --scaling_method fisher --ppl_target 40 --use_cache
...
# python asvd.py --model_id="meta-llama/Llama-2-7b-hf" --act_aware --alpha 0.5 --n_calib_samples 32 --scaling_method fisher --param_ratio_target 0.9 --use_cache
